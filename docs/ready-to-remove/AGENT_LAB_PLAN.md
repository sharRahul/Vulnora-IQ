> Moved to `docs/ready-to-remove/` during the documentation cleanup on 2026-06-28. Review and delete if the active Agent Lab guide and implementation status cover everything still needed.
