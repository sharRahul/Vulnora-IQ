> Moved to `docs/ready-to-remove/` during the documentation cleanup on 2026-06-28. Review and delete if implementation status, scorecard, and assurance docs now cover this completed readiness tranche.
